...
@WebServlet(name = "EmployeeManagement", value = "/_manager/employee")
public class EmployeeManagement extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (activity == null || !accountType.equals("Manager")) {
            ...
            url = "/WEB-INF/manager/employee-management.jsp";
        }
        // end check

        List<Employee> employeeList = AccountDB.selectAll(Employee.class);
