...
<%--        <li class="nav-item"><a href="/payment" class="nav-link">Thanh toán hoá đơn</a></li>--%>
        <li class="nav-item"><a href="/savings" class="nav-link">Gửi tiết kiệm</a></li>
      ...
      <div class="d-md-flex justify-content-md-end flex-grow-1">
        <div class="d-md-inline d-none dropdown-center">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a href="/sign-out" class="dropdown-item">Đăng xuất</a></li>
          </ul>
        </div>
        <div class="d-md-none d-inline">
          <ul class="navbar-nav">
            <li class="nav-item"><a href="/change-information" class="nav-link">Thông tin cá nhân</a></li>
            <li class="nav-item"><a href="/change-password" class="nav-link">Đổi mật khẩu</a></li>
            <li class="nav-item"><a href="/sign-out" class="nav-link">Đăng xuất</a></li>
          </ul>
        </div>
      </div>
    </div>
