    ...
    <div class="m-sm-5 p-5 shadow">
      ...
      <form action="" method="post">
        ...
        <div class="mb-2">
          ...
          <input type="text" name="loan-purpose" id="loan-purpose" class="form-control">
        </div>
        ...
        <div class="mb-2">
          <div class="row">
            <div class="col-sm-6 mb-sm-0 mb-3">
              ...
              <input type="text" name="loan-total-amount" id="loan-total-amount" class="form-control">
            </div>
        ...
        <div class="mb-2">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" name="available-amount" id="available-amount" class="form-control">
            </div>
          </div>
        </div>
        ...
        <div class="mb-2">
          ...
          <input type="text" name="loan-purpose" id="period" class="form-control">
        </div>

        <div class="d-flex justify-content-sm-end justify-content-center mt-3">
          <input type="hidden" name="action" value="">
          <button class="btn btn-primary me-2" formaction="/loan">Hủy</button>
          <button class="btn btn-primary" formaction="/loan">Tạo yêu cầu</button>
        </div>
